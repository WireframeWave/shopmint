...
const PricingTier: React.FC<PricingTierProps> = ({
  ...
  return (
    <div className={`relative flex flex-col h-full rounded-3xl p-8 transition-all duration-300 ${isDark
...
export const Pricing: React.FC<{ onContactClick?: () => void }> = ({ onContactClick }) => {
        ...
        <div className="mt-20 lg:mt-32">
          <div className="bg-techno-primary rounded-[3rem] p-8 lg:p-12 overflow-hidden relative shadow-2xl shadow-indigo-200">
            ...
            <div className="flex flex-col items-center justify-center text-center relative z-10 max-w-3xl mx-auto">
              ...
              <Button
                variant="white"
                className="border-none px-10 py-4 text-lg shadow-lg"
